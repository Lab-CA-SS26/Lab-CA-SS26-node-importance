...
function run_topk_comparison()
    ...
    for (rel_path, is_directed) in instances
        ...
        println("\n=== Benchmarking Dataset: $dataset_name (Directed: $is_directed) ===")
        ...
        if isfile(cache_file)
            ...
            println("Exact calculation finished. Saving to cache...")
        ...
        for k in K_VALUES
            ...
            push!(results, (
                dataset_name, is_directed, k, 
                kadabra_time, overlap_kad, tau_kad, ndcg_kad, 
