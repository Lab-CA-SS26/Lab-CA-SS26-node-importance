    ...
    def __post_init__(self, save_path):
        ...
        if save_path is not None and save_path.exists():
            ...
            try:
                ...
                print(f"Error loading cache at {save_path}: {e}")
        ...
        if save_path is not None:
            ...
            # Save to a temporary file then rename to avoid partial writes/reads race condition
            temp_path = str(save_path) + ".tmp"
            torch.save(self.graphs, temp_path)
...
class GraphDataModule(LightningDataModule):
    ...
    def __init__(self,
                 ...
                 cache_dir: Union[str, os.PathLike, None] = None, seed: int = 42,
        ...
        self.seed: int = seed  # Store seed for unique file naming
    ...
    def train_dataloader(self, *args, **kwargs) -> DataLoader:
        ...
        """
        # Append seed to filename to ensure uniqueness across concurrent runs
        dataset_path = self.cache_dir / f'train_ep{self.train_epochs}_' \
                                        f'{self.min_nodes}_{self.max_nodes}_{self.graph_type}_seed{self.seed}.data'
